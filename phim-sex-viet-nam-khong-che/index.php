...
if (isset($_GET["m"])) {
  ...
  $titleData = " Phim Sex Việt Nam Không Che - Xem Phim Sex Vietsub Phụ ";
}
?>
...
<head>
    ...
    <title><?php echo $titleData; ?></title>
    <meta name="description" content="Phim sex Việt Nam không che, có tiếng mới nhất mang đến những Clip sex Việt Nam với đầy đủ thể loại sex gái xinh, học sinh, máy bay bà già hấp dẫn." />
	<!--Ads Start-->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark top_menu">
      <div class="container mobile_header">
        <a class="logo navbar-brand" href="register.html">Máy chủ phim</a>
  ...
  <div class="container">
      <div class="header">
        <h1 class="text-center"><?php echo $titleData; ?></h1>
		<!--Ads Start--
...
<!--ADS-->
	  ...
	  <div class="text-center">
		<a class="btn btn-outline affiliate" href="register.html">Xem ngay</a>
		<!--Ads Start--
	  ...
	  <br />
           ...
           <center> <div class="col-md-7">
			<div class="device-features__content text-left">
				<p class="sub_headline"><center><?php echo $titleData; ?> Phát trực tiếp từ mọi nơi mọi lúc. Tối ưu hóa cho PC, Mac, iPad, iPhone, Android, Tab.<center></p>
				...
				<center> <a href="register.html" class="btn btn-md btn-outline affiliate">Tạo tài khoản miễn phí</a> </center>
				<!--Ads Start--
  ...
  <footer class="footer">
      <div class="container">
		  ...
		  <div class="col-md-6 col-xs-12">
		  	<div class="copyright">Copyright @ campusmanagement.com | All rights reserved</div>
		  </div>
		  <div class="col-md-6 col-xs-12">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modal_header_info">
        <h6 class="modal-title text-center" id="exampleModalLabel">Vui lòng đăng ký để xem <?php echo $titleData; ?></h6>
      ...
      <div class="modal-body">
        <div class="row">
			<div class="col-md-6">
				...
				<a class="affiliate btn btn-block btn-success" href="register.html" target="">Đăng ký miễn phí ngay!</a>
			</div>
			<div class="col-md-6">
				<div class="list-group">
					<div class="list-group-item modal-list">
						<h6 class="list-group-item-heading"><i class="fa fa-film biru fa-fw"></i> Phát trực tuyến chất lượng cao</h6>
						<p class="list-group-item-text"><?php echo $titleData; ?> có sẵn ở Chất lượng HD hoặc thậm chí cao hơn!</p>
					</div>
					<div class="list-group-item modal-list">
						<h6 class="list-group-item-heading"><i class="fa fa-youtube-play pink fa-fw"></i> Xem không giới hạn</h6>
						<p class="list-group-item-text">Bạn sẽ được truy cập vào tất cả Phim yêu thích của mình mà không có bất kỳ giới hạn nào.</p>
					</div>
					<div class="list-group-item modal-list">
						<h6 class="list-group-item-heading"><i class="fa fa-ban coklat fa-fw"></i> No Ads, 100% Free Advertising</h6>
						<p class="list-group-item-text">Tài khoản của bạn sẽ luôn không có bất kỳ loại quảng cáo nào.</p>
					</div>
					<div class="list-group-item modal-list">
						<h6 class="list-group-item-heading"><i class="fa fa-tablet ijo fa-fw"></i> Watch anytime, anywhere</h6>
...
_Hasync.push(['Histats.start', '1,4856868,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?4856868&101" alt="free webpage hit counter" border="0"></a></noscript>
<!-- Histats.com  END  -->